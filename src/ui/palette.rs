//! SysVibe — Catppuccin Macchiato color palette.
//!
//! All UI colors are defined here so they can be imported from a single
//! location and swapped for a different theme in the future.
